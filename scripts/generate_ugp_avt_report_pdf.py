...
ROADMAP = [
    ...
    ("Блок 2. Презентация линейки", date(2026, 8, 25), date(2026, 8, 29), "продукт / продажи"),
    ("Блок 3. Совещание по продвижению", date(2026, 9, 1), date(2026, 9, 2), "продажи / маркетинг / финансы"),
